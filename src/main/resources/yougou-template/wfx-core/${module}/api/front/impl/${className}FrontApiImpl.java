...
package ${basepackage}.${module}.api.front.impl;
...
import ${basepackage}.${module}.api.front.I${className}FrontApi;
...
/**
 * I${className}FrontApi实现
 * @author ${author}
 * @Date 创建时间：${now?string('yyyy-MM-dd HH:mm:ss')}
 */
@Service
public class ${className}FrontApiImpl implements I${className}FrontApi{
