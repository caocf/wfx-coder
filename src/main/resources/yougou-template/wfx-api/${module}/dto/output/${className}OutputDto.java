...
package ${basepackage}.${module}.dto.output;
<#assign className = table.className>   
<#assign classNameLower = className?uncap_first>
<#assign entity = className + "OutputDto">
<#assign entityLower = classNameLower + "OutputDto">
 ...
 */
public class ${className}OutputDto extends OutputDto {
